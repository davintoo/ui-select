...
!function () {
    ...
    i.directive("uiSelectChoices", ["uiSelectConfig", "uisRepeatParser", "uiSelectMinErr", "$compile", function (e, t, i, c) {
        ...
        function o(e, t) {
            var i, c, l = [];
            for (i = 0; i < t.length; i++)for (c = 0; c < e.length; c++)e[c].name == [t[i]] && l.push(e[c]);
            return l
        }
        ...
        function d() {
            ...
            if (!(p.activeIndex < 0)) {
                var c = t[p.activeIndex], l = c.offsetTop + c.clientHeight - e[0].scrollTop, s = e[0].offsetHeight;
        ...
        p.isEmpty = function () {
            ...
            p.disabled || p.open || (i || r(), t.$broadcast("uis:activate"), p.open = !0, p.activeIndex = p.activeIndex >= p.items.length ? 0 : p.activeIndex, -1 === p.activeIndex && p.taggingLabel !== !1 && (p.activeIndex = 0), c(function () {
            ...
            function l(e) {
                ...
                if (p.groups = [], angular.forEach(e, function (e) {
                        var t = angular.isFunction(l) ? l(e) : e[l], i = p.findGroupByName(t);
                        i ? i.items.push(e) : p.groups.push({name: t, items: [e]})
                    }), c) {
                    var s = t.$eval(c);
            ...
            p.setItemsFn = i ? l : a, p.parserResult = s.parse(e), p.isGrouped = !!i, p.itemProperty = p.parserResult.itemName, p.refreshItems = function (e) {
                ...
                var i = p.selected;
                if (angular.isArray(i) && !i.length || !p.removeSelected)p.setItemsFn(e); else if (void 0 !== e) {
        ...
        p.refresh = function (e) {
            ...
            if (!p.open)return !1;
            var t = p.items.indexOf(e[p.itemProperty]), i = t === p.activeIndex;
            return !i || 0 > t && p.taggingLabel !== !1 || 0 > t && p.taggingLabel === !1 ? !1 : (i && !angular.isUndefined(p.onHighlightCallback) && e.$eval(p.onHighlightCallback), i)
        }, p.isDisabled = function (e) {
            if (p.open) {
                var t, i = p.items.indexOf(e[p.itemProperty]), c = !1;
            ...
            if (void 0 === e || !e._uiSelectChoiceDisabled) {
                ...
                if (!e || !e._uiSelectChoiceDisabled) {
                    ...
                    s[p.parserResult.itemName] = e, c(function () {
                        p.onSelectCallback(t, {$item: e, $model: p.parserResult.modelMapper(t, s)})
        ...
        p.sizeSearchInput = function () {
            var e = p.searchInput[0], i = p.searchInput.parent().parent()[0], l = function () {
                return $(i).width()
            }, s = function (t) {
                if (0 === t)return !1;
                var i = t - e.offsetLeft;
                return 50 > i && (i = t), p.searchInput.css("width", i + "px"), !0
            };
        ...
        return {
            ...
            compile: function (l, a) {
                return angular.isDefined(a.multiple) ? l.append("<ui-select-multiple/>").removeAttr("multiple") : l.append("<ui-select-single/>"), function (l, a, r, o, u) {
                    function d(e) {
                        if (h.open) {
                            var t = !1;
                            if (t = window.jQuery ? window.jQuery.contains(a[0], e.target) : a[0].contains(e.target), !t && !h.clickTriggeredSelect) {
                                var i = ["input", "button", "textarea"], c = angular.element(e.target).scope(), s = c && c.$select && c.$select !== h;
                    ...
                    h.generatedId = t.generateId(), h.baseTitle = r.title || "Select box", h.focusserTitle = h.baseTitle + " focus", h.focusserId = "focusser-" + h.generatedId, h.closeOnSelect = function () {
                        ...
                        h.disabled = void 0 !== r.disabled ? r.disabled : !1
                        ...
                        if (void 0 !== r.tagging) {
                            ...
                            h.tagging = {isActivated: !0, fct: e !== !0 ? e : void 0}
                        } else h.tagging = {isActivated: !1, fct: void 0}
                    }), r.$observe("taggingLabel", function () {
                        void 0 !== r.tagging && (h.taggingLabel = "false" === r.taggingLabel ? !1 : void 0 !== r.taggingLabel ? r.taggingLabel : "(new)")
                    }), r.$observe("taggingTokens", function () {
                        if (void 0 !== r.tagging) {
                            var e = void 0 !== r.taggingTokens ? r.taggingTokens.split("|") : [",", "ENTER"];
                            h.taggingTokens = {isActivated: !0, tokens: e}
                        }
                    ...
                    l.$watch("$select.open", function (t) {
                        if (t) {
                            ...
                            b[0].style.visibility = "hidden", n(function () {
                                var t = c(a), i = c(b);
                                t.top + t.height + i.height > e[0].documentElement.scrollTop + e[0].documentElement.clientHeight && (b[0].style.position = "absolute", a.addClass(x)), b[0].style.visibility = ""
                            })
                        } else {
                            if (null === b)return;
        ...
        return {
            restrict: "EA", require: "^uiSelect", replace: !0, transclude: !0, templateUrl: function (t) {
                var i = t.parent().attr("theme") || e.theme, c = t.parent().attr("multiple");
                return i + (c ? "/match-multiple.tpl.html" : "/match.tpl.html")
            }, link: function (t, i, c, l) {
                function s(e) {
                    l.allowClear = angular.isDefined(e) ? "" === e ? !0 : "true" === e.toLowerCase() : !1
                }
        ...
        return {
            restrict: "EA", require: ["^uiSelect", "^ngModel"], controller: ["$scope", "$timeout", function (e, t) {
                ...
                e.$evalAsync(function () {
                    ...
                    if (!s._uiSelectChoiceLocked) {
                        ...
                        n[l.parserResult.itemName] = s, l.selected.splice(i, 1), c.activeMatchIndex = -1, l.sizeSearchInput(), t(function () {
                            l.onRemoveCallback(e, {$item: s, $model: l.parserResult.modelMapper(e, n)})
                        }), c.updateModel()
                    }
                }, c.getPlaceholder = function () {
                    return l.selected.length ? void 0 : l.placeholder
                }
            }], controllerAs: "$selectMultiple", link: function (c, l, s, n) {
                function a(e) {
                ...
                function r(t) {
                    ...
                    var c = a(d.searchInput[0]), l = d.selected.length, s = 0, n = l - 1, r = g.activeMatchIndex, o = g.activeMatchIndex + 1, u = g.activeMatchIndex - 1, p = r;
                    return c > 0 || d.search.length && t == e.RIGHT ? !1 : (d.close(), p = i(), g.activeMatchIndex = d.selected.length && p !== !1 ? Math.min(n, Math.max(s, p)) : -1, !0)
                }
                ...
                function u(e, t) {
                    var i = -1;
                    if (angular.isArray(e))for (var c = angular.copy(e), l = 0; l < c.length; l++)if (void 0 === d.tagging.fct)c[l] + " " + d.taggingLabel === t && (i = l); else {
                        var s = c[l];
                ...
                var d = n[0], p = c.ngModel = n[1], g = c.$selectMultiple;
                d.multiple = !0, d.removeSelected = !0, d.focusInput = d.searchInput, p.$parsers.unshift(function () {
                    ...
                    var t, i = d.parserResult.source(c, {$select: {search: ""}}), l = {};
                    if (!i)return e;
                    var s = [], n = function (e, i) {
                        if (e && e.length) {
                    ...
                    if (e.isVerticalMovement(t.which) || c.$evalAsync(function () {
                        ...
                        var i, l, s, n, a = angular.copy(d.items), r = angular.copy(d.items), p = !1, g = -1;
                        if (void 0 !== d.tagging.fct) {
                            if (s = d.$filter("filter")(a, {isTag: !0}), s.length > 0 && (n = s[0]), a.length > 0 && n && (p = !0, a = a.slice(1, a.length), r = r.slice(1, r.length)), i = d.tagging.fct(d.search), i.isTag = !0, r.filter(function (e) {
        ...
        return {
            restrict: "EA", require: ["^uiSelect", "^ngModel"], link: function (c, l, s, n) {
                var a = n[0], r = n[1];
        ...
        return {
            require: "^uiSelect", link: function (t, c, l, s) {
                if (null === t[l.uiSelectSort])throw i("sort", "Expected a list to sort");
                var n = angular.extend({axis: "horizontal"}, t.$eval(l.uiSelectSortOptions)), a = n.axis, r = "dragging", o = "dropping", u = "dropping-before", d = "dropping-after";
                t.$watch(function () {
                    return s.sortable
                }, function (e) {
        ...
        i.parse = function (i) {
            ...
            return {itemName: c[2], source: t(c[3]), trackByExp: c[4], modelMapper: t(c[1] || c[2])}
